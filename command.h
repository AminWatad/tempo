		...
		int cmdExecute() {
            ...
            if (strcmp(cmds[0],testing) == 0) {
                ...
                if (option == "-e") { 
                    ...
                    if (S_ISREG(buf.st_mode)) cout << "it's a reg." << endl;
                    else cout << "exists but not reg." << endl;
                }
                else if (option == "-d") {
                    if (S_ISDIR(buf.st_mode)) cout << "it's a dir." << endl;
                    else cout << "exists but not a dir." << endl;
                }
            }
